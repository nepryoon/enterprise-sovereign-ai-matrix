...
from app.domain import (ExecutionStatus, IllegalTransitionError, ModelClass, ModelInvocation,
                        validate_transition)
...
def test_cost_calculation():
    invocation = ModelInvocation(model_class=ModelClass.FAST, provider="litellm", model="fast",
                                 latency_ms=10, prompt_tokens=1_000_000,
                                 completion_tokens=1_000_000, output="ok")
