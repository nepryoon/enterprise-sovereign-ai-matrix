# Two-minute recruiter demonstration

1. Open **Command Centre** and identify the synthetic EU critical-infrastructure request, active
...
4. Open **Run Detail** to show event lineage, agent runs, route, decision result, correlation ID,
   trace ID, cost, and latency. Use **Replay** only as explicitly labelled deterministic replay.
